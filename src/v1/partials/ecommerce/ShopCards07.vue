<template>
  <!-- Card 1 -->
  <div class="col-span-full md:col-span-6 xl:col-span-3 bg-white shadow-lg rounded-sm border border-slate-200 overflow-hidden">
    <div class="flex flex-col h-full">
      ...
      <div class="grow flex flex-col p-5">
        ...
        <div class="grow">
          <header class="mb-2">
            <a href="#0">
              <h3 class="text-lg text-slate-800 font-semibold mb-1">Form Builder CP</h3>
            </a>
        ...
        <div class="flex flex-wrap justify-between items-center">
          ...
          <!-- Price -->
          <div>
            <div class="inline-flex text-sm font-medium bg-rose-100 text-rose-600 rounded-full text-center px-2 py-0.5">$39.00</div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="flex flex-col h-full">
      ...
      <div class="grow flex flex-col p-5">
        ...
        <div class="flex flex-wrap justify-between items-center">
          ...
          <!-- Price -->
          <div>
            <div class="inline-flex text-sm font-medium bg-emerald-100 text-emerald-600 rounded-full text-center px-2 py-0.5">$69.00</div>
          </div>
        </div>
      </div>
    </div>
